...
$router->delete('/mark/:id', [MarcaController::class, 'destroy']);
$router->delete('/category/:id', [CategoriaController::class, 'destroy']);
$router->delete('/ram/:id', [RamController::class, 'destroy']);
$router->delete('/disk/:id', [DiscoController::class, 'destroy']);
$router->delete('/screen/:id', [PantallaController::class, 'destroy']);
$router->delete('/location/:id', [UbicacionController::class, 'destroy']);
$router->delete('/seat/:id', [SedeController::class, 'destroy']);
$router->delete('/role/:id', [RolController::class, 'destroy']);
$router->delete('/app/:id', [AplicacionController::class, 'destroy']);
$router->delete('/file/:id', [ArchivoController::class, 'destroy']);
$router->delete('/device/:id', [EquipoController::class, 'destroy']);
$router->delete('/record/:id', [HistorialController::class, 'destroy']);
$router->delete('/employee/:id', [EmpleadoController::class, 'destroy']);
$router->delete('/service/:id', [ServicesController::class, 'destroy']);
$router->delete('/installation/:id', [InstallationController::class, 'destroy']);
$router->delete('/move/:id', [MovementsController::class, 'destroy']);
